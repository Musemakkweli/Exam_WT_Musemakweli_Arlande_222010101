...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5 mt-4">
            <h1 class="display-2 text-white mb-3 animated slideInDown">UPDATE PAGE</h1>
    ...
    <div class="container">
        ...
        <form action="update_settings.php" method="POST">
            ...
            <input type="password" id="password" name="password" value="<?php echo htmlspecialchars($userData["Password"]); ?>" required><br><br>
